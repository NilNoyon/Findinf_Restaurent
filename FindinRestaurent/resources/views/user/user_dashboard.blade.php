...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  		<a class="navbar-brand" href="{{route('User_Dashboard')}}">Restaurant Finding</a>
  			...
  			<div class="collapse navbar-collapse" id="navbarSupportedContent">
			    <ul class="navbar-nav mr-auto">
			      <li class="nav-item active">
			        <a class="nav-link" href="{{route('User_Dashboard')}}">Home <span class="sr-only">(current)</span></a>
			      </li>
			      <li class="nav-item">
...
<!-- jvmbutton -->
	...
	<div class="jumbotron">
		<span class="d-block p-2 bg-dark text-white">
		  ...
		  <p style="color: red;">Use Coupon for 15% Discount !!</p>
		  <!-- <a class="btn btn-primary btn-lg" href="#" role="button">Let's Start</a> -->
		  <!-- Button trigger modal -->
			<button class="btn btn-info" onclick="getCoupon()">Click to get coupon</button>
			<p id="coupon_text" style="color: red;"></p>
		</span>
	</div>
...
<!-- bootstrapjs -->
	...
	<script type="text/javascript">
		...
		function getCoupon(){
			counter++;
			if(counter == 1){
				var x = document.getElementById("coupon_text");
  				x.innerHTML = Math.floor((Math.random() * 100000) + 1);
			}else{
				var x = document.getElementById("coupon_text");
  				x.innerHTML = 'You already get a coupon number !';
  			}
		}
	</script>
</body>
