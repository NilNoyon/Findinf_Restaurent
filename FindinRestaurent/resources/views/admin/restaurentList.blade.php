...
<body>
    ...
    <div class="content">
        <h1>All Restaurent Location</h1>
        <a href="{{ route('AddRestaurent')}}" type="Button">Add Restaurent</a>
        <div id="box">
            <table width="1000" style="background-color: white;">
              ...
              <tbody>
                @if(isset($restaurents))
                  ...
                  <tr>
                    <td align="center">{{ $restaurent->name }}</td>
                    <td align="center">{{ $restaurent->address }}</td>
                    <td align="center">{{ $restaurent->contact }}</td>
                    <td align="center">{{ $restaurent->email }}</td>
                    <td align="center">{{ $restaurent->location->police_station }}</td>
                    <td align="center">{{ $restaurent->preference_type->preference_type }}</td>
                  </tr>
                  @endforeach
                @endif
              </tbody>
