        ...
        <div id="box">
            <table width="900" style="background-color: white;">
              ...
              <tbody>
                ...
                <tr>
                  <td align="center">{{ $location->police_station }}</td>
                  <td align="center">{{ $location->district }}</td>
                </tr>
                @endforeach
              </tbody>
            </table>
            <form method="POST">
              ...
              <table width="900" style="background-color: white;">
                ...
                <tbody>
                  <tr>
                    <td align="center"><input type="text" name="police_station"></td>
                    <td align="center"><input type="text" name="district"></td>
                  </tr>
                  <tr>
                    <td align="center"><button type="submit" class="btn btn-outline-success my-2 my-sm-0">SUBMIT</button></td>
                  </tr>
                </tbody>
              </table>
            </form>
